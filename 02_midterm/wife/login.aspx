...
<body>
    ...
    <div>
        ...
        <p>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:login %>" ProviderName="<%$ ConnectionStrings:login.ProviderName %>" SelectCommand="SELECT * FROM [person] WHERE (([密碼] = ?) AND ([帳號] = ?))">
                <SelectParameters>
                    <asp:ControlParameter ControlID="password" Name="密碼" PropertyName="Text" Type="String" />
                    <asp:ControlParameter ControlID="username" Name="帳號" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </p>
        <p>
